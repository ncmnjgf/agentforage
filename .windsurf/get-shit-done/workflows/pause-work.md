...
```bash
timestamp=$(node "C:/Users/Tech Galaxy/Music/AgentForger/.windsurf/get-shit-done/bin/gsd-tools.cjs" current-timestamp full --raw)
```
...
<step name="commit">
```bash
node "C:/Users/Tech Galaxy/Music/AgentForger/.windsurf/get-shit-done/bin/gsd-tools.cjs" commit "wip: [phase-name] paused at task [X]/[Y]" --files .planning/phases/*/.continue-here.md .planning/HANDOFF.json
```
</step>
